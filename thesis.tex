...
\subtitle{Eine populaere Videospielwelt als Simulationsumgebung fuer eine kognitive kuenstliche Intelligenz}

\referee{Prof.~Dr.~Martin Wirsing}
\supervisor{Annabelle Klarl}
...
\input{text/technologien}
\input{text/technologien_spezial}
\input{text/technologie_konkret}
\input{text/eigene_technologie}
\input{text/server_komponente}
\input{text/client_komponente}
\input{text/visualisierung}
\input{text/experiment}
\input{text/analyse_und_zusammenfassung}
