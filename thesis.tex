...
\thesisAuthor{Arthur Dent}
\thesisProgram{Informatik Master}

\thesisTitle{Fragengenerierung durch genetische Programmierung}

% Do not delete this command!
% If you do not have a a subtitle, leave it empty!
\subtitle{Finale Definition der Frage zur Antwort 42}

\referee{Prof.~Dr.~Martin Wirsing}
\supervisor{PST Mitarbeiter}

\handInDate{15. Januar 2020}
