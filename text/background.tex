...
Furthermore each neuron has an activation value, that it receives from and forwards to other neurons. Links in between neurons can be modified to dynamically modulate the forwarded activation value.
...
\begin{figure}[h]
  \centering
    \includegraphics[width=10cm]{graphics/partonomy}
