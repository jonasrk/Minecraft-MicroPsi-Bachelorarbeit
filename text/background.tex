...
Dörner's ``Bauplan für eine Seele''~\cite{Doerner1998} (``blueprint for a mind'') belongs in the interdisciplinary field Cognitive Science, as Dörner with his theory tries to research psychological foundations with the methods of Computer Science. The book tries to explain the mind. It has a notable focus on the emotional system and adresses what is called symbolic and sub-symbolic reasoning. The theory is an attempt to represent the mind as a machine. The mind is looked at as a fuzzy and self-extending causal network structure.
...
\begin{figure}[h]
  ...
  \caption{Quads like these are the basic representational unit of the Psi theory (taken from \cite{Bach:2009:PSI:1611304})}
  \label{quad}
\end{figure}
