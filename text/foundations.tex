...
Minecraft can certainly be called a world wide phenomenom. The games developers received a number of prizes for their creation - not to mention the millions of dollars that have been earned. With its huge succes, Minecraft has proved clearly that it compelled to many players.

The development process of Minecraft is very different from most well-known games. Instead of building the game game over months or years to finally release a (more or less) finished version to the public, Minecraft is being designed iteratively. In fact, Persson released the first version only a week after he started working on the game. Ever since, new features have been added and new versions of the game have been released frequently. Another defining aspect of Mojangs approach towards the development of Minecraft is the involvement of the games players. Since the earliest stages future plans have been discussed openly and many times the voices of the players have been heard.~\cite{Duncan:2011:MBC:2207096.2207097}

Unlike any other game, Minecraft fosters the creativity of its players. Bringing the construction component to one extreme after the other, well publicized creations include a life-size model of the USS Enterprise-D as well as a fully functional arithmetic unit. Videos of roller coaster rides through complex constructions increasingly show characteristics of an art form itself --- regarding to the amount of views on youtube, not less, than other, well established formats.

With more and more applications that move beyond the original construction and survival, Minecraft seems to slowly shift towards being not only a game, but a gaming platform, that many other people use to implement their own ideas. Inside Minecraft worlds players build games for educational purposes. A group of students of the Miami University developed a game called Circuit Magic that dedicated to teach the player about Logical circuits.

Just as well, games have been developed for the purpose of artistic expression.

Before a new Minecraft game begins, it procedurally generates a three-dimensional world. The player is then dropped to a spawn point. The player is now facing a scenario with a minimal game interface lacking any kind of instruction or advise about what to do next.

One can assume, that the obvious connotation to Lego(TM) is more than coincidence, as it immediately gives the player a clue, about what kind of possibilities and building and creating the game may deliver.

Looking at the game for the first time, it is impossible to oversee the primitive appearance of the games graphics.

Everything in the game is made of these blocks. May it be the leaves of a tree, iron and stone or the clouds. Even the sun does not appear round, but as a cubic object.
