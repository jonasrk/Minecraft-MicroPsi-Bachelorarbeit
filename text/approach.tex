...
%TODO world und world adapter aufsplitten. Also: who has data sources and targets. check multiplizitäten

%TODO Das ist kein UML

\begin{figure}[h]
  \centering
    \includegraphics[width=10cm]{graphics/UML_MicroPsi_mit_spock_v13}
...
\begin{figure}[h]
  \centering
    \includegraphics[width=12cm]{graphics/sequencediagram}
  \caption{A simplified sequence diagram of the flow of data in between the web browser, MicroPsi and a Minecraft server}
  \label{spock_loop}
\end{figure}
...
%TODO UML?????? das gefällt mir gar nicht!
